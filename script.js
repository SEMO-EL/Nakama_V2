...
blackGate.addEventListener("mouseenter", () => gate.style.setProperty("--black-width", "67.5%"));
whiteGate.addEventListener("mouseenter", () => gate.style.setProperty("--black-width", "32.5%"));
